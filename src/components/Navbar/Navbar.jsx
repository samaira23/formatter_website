      ...
      <div className="navbar__inner">
        ...
        <a href="/" className="navbar__logo">
          ...
          <div className="navbar__logo-wordmark">
            <span className="navbar__logo-name">PaperFormat</span>
            <span className="navbar__logo-tag">Research Tool</span>
          </div>
        </a>

        {/* Nav links */}
        <ul className="navbar__links">
          <li><a href="#formatter" className="navbar__link">Formatter</a></li>
          <li><a href="#how-it-works" className="navbar__link">How It Works</a></li>
          <li><a href="#features" className="navbar__link">Features</a></li>
          <li><a href="#docs" className="navbar__link">Docs</a></li>
        </ul>
